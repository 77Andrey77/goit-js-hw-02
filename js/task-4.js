...
// Если длина больше 40 символов, то функция обрезает
// строку до 40 - ка символов и добавляет в конец строки 
...
const formatString = function (string) {
  ...
  if (string.split('').length > maxLength) {
    const newString = string.split('').slice(0,maxLength).join('')+('...');
